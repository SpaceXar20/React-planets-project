...
const Container = (props) => {
  return (
    <div className="container"> 
      ...
      {/* Planets List */}
      {/*Use map to iterate over planets array to return a new array called planet with the following props */}
...
ReactDOM.render(
  // the planets array is now available to the Container as props
  <Container initialPlanets = {planets} />, //React.DOM.render usually renders your top level element in the DOM, in this case App, and pass a prop for players
